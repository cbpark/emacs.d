...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     (linum ((,class (:background ,background))))
     ...
     (cider-repl-input-face ((,class (:weight normal :underline nil))))
     (cider-repl-prompt-face ((,class (:underline nil :weight bold :foreground ,purple))))
     (cider-repl-result-face ((,class (:foreground ,green))))
     (cider-repl-output-face ((,class (:foreground ,blue :background ,background))))
