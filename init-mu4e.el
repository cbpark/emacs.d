...
(setq mu4e-sent-folder
      (lambda (msg)
        (if (and msg (mu4e-message-contact-field-matches msg :to "malice.doomed@gmail.com"))
            "/malice.doomed_gmail.com/[Google Mail].Sent Mail"
          "/cbpark_gmail.com/[Google Mail].Sent Mail")))

(setq mu4e-drafts-folder
      (lambda (msg)
        (if (and msg (mu4e-message-contact-field-matches msg :to "malice.doomed@gmail.com"))
            "/malice.doomed_gmail.com/[Google Mail].Drafts"
          "/cbpark_gmail.com/[Google Mail].Drafts")))

(setq mu4e-trash-folder
      (lambda (msg)
        (if (and msg (mu4e-message-contact-field-matches msg :to "malice.doomed@gmail.com"))
            "/malice.doomed_gmail.com/[Google Mail].Bin"
          "/cbpark_gmail.com/[Google Mail].Trash")))
...
(setq message-sendmail-extra-arguments
      '("--passwordeval" "'/opt/local/bin/gpg -d ~/.auth/mail.cern.ch.gpg'"))
