...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nix-mode company-nixos-options cmake-mode markdown-mode yaml-mode pkgbuild-mode company-jedi cdlatex hlint-refactor company-ghci company-cabal flycheck-haskell haskell-mode gnuplot ggtags company-c-headers c-eldoc latex-preview-pane company-math auctex htmlize magit paredit expand-region undo-tree anzu company helm-flycheck flycheck helm-projectile projectile helm-descbinds helm-ls-git helm-swoop helm hlinum zenburn-theme exec-path-from-shell)))
